      ...
      <main className="flex-1">
        ...
        <section className="py-12 px-4 border-b border-border">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl font-bold mb-4">Nội dung học tập</h1>
            <p className="text-foreground/70 text-lg">
              Khám phá các phần chi tiết về cạnh tranh, độc quyền và lý thuyết
              kinh tế Mác-Lênin
            </p>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-6 items-stretch">
              {chaptersData.map((chapter) => (
                ...
                >
                  ...
                  <p className="text-foreground/70 text-sm mb-4 break-words overflow-hidden text-ellipsis">
                    {chapter.description}
                  </p>
